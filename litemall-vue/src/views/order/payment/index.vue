    ...
    <div class="pay_way_group">
      ...
      <van-radio-group v-model="payWay">
        <van-cell-group>
          ...
          <van-cell>
            <template slot="title">
              <img src="../../../assets/images/pp_pay.jpg" alt="PayPal" width="113" height="23" />
            </template>
            <van-radio name="pp" />
          </van-cell>
        </van-cell-group>
  ...
  methods: {
    ...
    pay() {
      Dialog.alert({
        ...
        } else if (this.payWay === 'pp') {
          Dialog.alert({ message: '你选择了Paypal支付。' });
          orderPayPalPay({ orderId: this.orderId })
            .then(res => {
              ...
              // let paypal_data = JSON.stringify({
              //   id: data.id,
              //   links: data.links,
